/* Base Ori : Rizki BOTZ
Script Ori : Rizki BOTZ
Nama Base : KuzaBase
Nama Script : ScStore
Recode : Rizki BOTZ
Youtube Author : RIZKI RIDHO PRATAMA
Youtube Recode : RIZKI
...
let ownername = '*_｢ RIZKI ｣_*' //NAMA OWNER
let owner = '6287840411119' // NOMOR OWNER
let symbol = '*🦅*'
...
const ytabilbotz = "6287840411119@s.whatsapp.net"
const txt = mek.message.conversation
const botNumber = kuza.user.jid
const ownerNumber = [`${owner}@s.whatsapp.net`, `6287840411119@s.whatsapp.net`, `6281256038434@s.whatsapp.net`]
